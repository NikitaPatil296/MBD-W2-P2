...
Vars=evalin('base','whos(''Clutch_LockUp_Model_output'')');
...
if ~isempty(find_system(0,'flat','name','sldemo_clutch')) && ...
   strcmp(get_param('Clutch_LockUp_Model','Open'),'off'),
  return
end
...
TempInputName=find_system('Clutch_LockUp_Model', ...
                          'SearchDepth',1, ...
...
ModelPos=get_param('Clutch_LockUp_Model','Location');

FigX=0;FigY=0;
%%% Create Everything %%%    
Fig=figure('Units'          ,'points'                                , ...
           'Position'       ,[FigX FigY FigWidth FigHeight]          , ...
           'CloseRequestFcn','Clutch_LockUp_Model Close'                      , ...
           'Menubar'        ,'none'                                  , ...
           'Colormap'       ,[]                                      , ...
           'NumberTitle'    ,'off'                                   , ...
...
for lp=1:length(Names),    
  UI(lp)=uicontrol('Style'   ,'checkbox'       , ...
                   ...
                   'Units'   ,'normalized'     , ...               
                   'String'  ,Names{lp}        , ...
                   'Callback','Clutch_LockUp_Model Plot', ...                       
                   'Tag'     ,Names{lp}          ...
                   );
end % for lp
